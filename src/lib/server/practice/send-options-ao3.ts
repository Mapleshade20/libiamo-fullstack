import { buildChatMessages } from "$lib/components/practice/session/chat-messages";
import type { CommentThreadMetadata } from "$lib/components/practice/session/comment-thread";
import {
...
import type { SubmitMessageOptions } from "$lib/server/practice/session";
