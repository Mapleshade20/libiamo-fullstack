import { type MarkedTextPart, parseMarkedText } from "$lib/text/marked-text";
import type { TranslationCardWarning, TranslationDiffPart } from "$lib/translation/evaluation";
