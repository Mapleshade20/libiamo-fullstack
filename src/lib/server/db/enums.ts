...
import { CADENCES, INTERACTION_TYPES, LANGUAGE_CODES, PRACTICE_SESSION_STATUSES, UI_VARIANTS, URGENCIES } from "$lib/constants";
...
export const sessionStatusEnum = pgEnum("session_status", [...PRACTICE_SESSION_STATUSES]);
