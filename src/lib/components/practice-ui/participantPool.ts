import { COLOR_POOL, STATUS_POOL, USER_POOL } from "./participantData";
import type { PracticeParticipant } from "./types";
...
export function initUserPool(seedId: number) {
	...
	const agentUser: PracticeParticipant = {
		id: "agent",
	...
	const onlineUsers: PracticeParticipant[] = [];
	...
	const offlineUsers: PracticeParticipant[] = [];
