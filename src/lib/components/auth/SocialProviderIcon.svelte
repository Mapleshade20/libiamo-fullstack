...
let { provider, class: className = "size-4" }: Props = $props();
</script>

{#if provider === "google"}
	<svg class={className} viewBox="0 0 24 24" aria-hidden="true">
		<path fill="#4285f4" d="M21.6 12.23c0-.71-.06-1.4-.2-2.05H12v3.87h5.37a4.6 4.6 0 0 1-1.99 3.01v2.51h3.23c1.89-1.74 2.99-4.3 2.99-7.34" />
		<path fill="#34a853" d="M12 22c2.7 0 4.96-.9 6.61-2.43l-3.23-2.51c-.9.6-2.04.95-3.38.95-2.6 0-4.81-1.76-5.6-4.13H3.07v2.59A10 10 0 0 0 12 22" />
