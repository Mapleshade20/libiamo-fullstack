...
let showTranslationHelpModal = $state(false);
...
function openTranslationHelpModal() {
	...
	showTranslationHelpModal = true;
}

function closeTranslationHelpModal() {
