...
import { type MessageSubmissionResult, submitPracticeMessage } from "$lib/components/practice/session/message-submission";
...
import { getMailContact, getMailContactFromOpeningEmails } from "./contacts";
