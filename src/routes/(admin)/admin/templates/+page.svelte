...
import { INTERACTION_TYPE_LABELS, INTERACTION_TYPES, LANGUAGE_CODES, LANGUAGE_LABELS, UI_VARIANT_LABELS } from "$lib/constants";
		...
		<Table.Body>
			{#each data.templates as tpl}
				<Table.Row>
					...
					<Table.Cell>{UI_VARIANT_LABELS[tpl.ui]}</Table.Cell>
