...
<Card.Root>
			...
			{#if data.error || form?.resetMessage}
				...
				>
					...
					<a
						...
						class="mt-4 block text-sm underline text-blue-600 hover:text-blue-800"
					>
					...
					<div class="space-y-2">
						...
						{#if form?.resetErrors?.newPassword && !suppressServerErrors}
							<p class="text-sm text-red-600">
								{form.resetErrors.newPassword[0]}
							</p>
						{/if}
					</div>
	...
	<Card.Footer class="text-sm">
		<a href="/sign-in" class="text-muted-foreground hover:underline"
			>Back to Sign In</a
		>
	</Card.Footer>
</Card.Root>
