...
- Server: `src/lib/server/` for auth (`auth/`), scheduling (`scheduling/`), db, LLM, sessions, feedback, notes, review-cards (FSRS), archive, translate. `src/lib/admin/` for template/variant action helpers.
