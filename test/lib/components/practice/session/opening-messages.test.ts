...
import type { ChatOpeningState, ChatUser } from "$lib/components/practice/session/chat-users";
import { getOpeningStateMessages } from "$lib/components/practice/session/opening-messages";
